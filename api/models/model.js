 ...
 */
class Resource {
    constructor(modell, preis, marke) {
        this.modell = modell
        this.preis = preis;
        this.marke = marke;
...
/* Task 1 - Part 2. Replace these three instances of the example Class Resource with instances
   of your own class */
model.add(new Resource("iPhone 15", 949, "Apple" ));
model.add(new Resource("Galaxy Z Fold5", 2259, "Samsung"));
model.add(new Resource("Xiaomi 13", 999, "Xiaomi"));
